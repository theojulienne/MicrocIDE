...
public class CPartitionScanner extends RuleBasedPartitionScanner {
	...
	public final static String C_STRING_LITERAL = "__c_doc_comment";
	...
	public CPartitionScanner( ) {
		...
		Token stringTok       = new Token( C_STRING_LITERAL );
		...
		rules.add( new SingleLineRule( "\"", "\"", stringTok, '\\', true, false ) );
